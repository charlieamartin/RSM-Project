...
file_csv1 = open('C:\\Users\\RDCHLCAM\\Documents\\RSM\\test_results\\Global_Error_Validation.csv', 'w')
file_csv1.write("{0},{1}\n".format("Absolute Error","Relative Error"))
file_csv2 = open('C:\\Users\\RDCHLCAM\\Documents\\RSM\\test_results\\lessthan200_Error_Validation.csv', 'w')
file_csv2.write("{0},{1}\n".format("Absolute Error","Relative Error"))
file_csv3 = open('C:\\Users\\RDCHLCAM\\Documents\\RSM\\test_results\\greaterthan200_Error_Validation.csv', 'w')
file_csv3.write("{0},{1}\n".format("Absolute Error","Relative Error"))
